...
function Generate_SSH() {
    ...
    ssh-keyscan -H $ipaddress >> ~/.ssh/known_hosts > /dev/null  # https://www.techrepublic.com/article/how-to-easily-add-an-ssh-fingerprint-to-your-knownhosts-file-in-linux/
